...
article = articles[14]
position1 = article.h3.text
company1 = article.find('span', {'class': 'dib mt5'}).text
date1 = article.find('span', {'class': 'txt_list_2'}).text
salary1 = article.find('span', {'class': 'salary_amount'}).text
city1 = article.find('span', {'class': 'list_city'}).text

# out =[]
out_posit_13 = f"miestas: {city}, kompanija: {company}, pozicija: {position}, atlyginimas: {salary}, paskelbimo data: {date}"
print(out_posit_13)
# print("- " * 20)
out_posit_14 = f'miestas: {city1}, kompanija: {company1}, pozicija: {position1}, atlyginimas: {salary1}, paskelbimo data: {date1}'
print(out_posit_14)
# print(dict(out_posit_14))
# out.append(out_posit_14)
# out.append(out_posit_13)
# str_out = str(out)
# print(str(str_out))
